<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseStatusOfLandUse.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseStatusOfLandUse" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Status Of Land Use</strong></h1>
        </asp:Panel>
