<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseKhasLandByRange.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseKhasLandByRange" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Khas Land By Range</strong></h1>
        </asp:Panel>
