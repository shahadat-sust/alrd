...
{
    public partial class UnionWiseStatusOfAffectedForConvertAgriLandToCommercialLandByRange : BaseControl
    {
        ...
        {
            string ReportSource = "../RDLC/RPT_UnionWiseStatusOfAffectedForConvertAgriLandToCommercialLandByRange.rdlc";
