<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseWaterBodyByRange.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseWaterBodyByRange" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Water Body By Range</strong></h1>
        </asp:Panel>
