<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseLandlessFamilyByRange.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseLandlessFamilyByRange" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Landless Family By Range</strong></h1>
        </asp:Panel>
