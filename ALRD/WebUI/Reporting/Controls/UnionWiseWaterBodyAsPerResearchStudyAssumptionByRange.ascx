<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseWaterBodyAsPerResearchStudyAssumptionByRange.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseWaterBodyAsPerResearchStudyAssumptionByRange" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Water Body By Range (As Per Research/Study/Assumption)</strong></h1>
        </asp:Panel>
