...
{
    public partial class UnionWiseKhasLandAsPerResearchStudyAssumption : BaseControl
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                entity.ReportType = "KhasLandAsPerResearchStudyAssumption";
        ...
        {
            string ReportSource = "../RDLC/RPT_UnionWiseKhasLandAsPerResearchStudyAssumption.rdlc";
