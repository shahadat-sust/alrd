<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseWaterBodyAsPerResearchStudyAssumption.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseWaterBodyAsPerResearchStudyAssumption" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Water Body (As Per Research/Study/Assumption)</strong></h1>
        </asp:Panel>
