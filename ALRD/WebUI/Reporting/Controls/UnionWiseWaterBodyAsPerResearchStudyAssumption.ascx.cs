...
{
    public partial class UnionWiseWaterBodyAsPerResearchStudyAssumption : BaseControl
    {
        ...
        {
            string ReportSource = "../RDLC/RPT_UnionWiseWaterBodyAsPerResearchStudyAssumption.rdlc";
