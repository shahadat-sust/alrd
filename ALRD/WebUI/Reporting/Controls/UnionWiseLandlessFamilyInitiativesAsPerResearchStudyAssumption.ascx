<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseLandlessFamilyInitiativesAsPerResearchStudyAssumption.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseLandlessFamilyInitiativesAsPerResearchStudyAssumption" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Landless Family & Initiatives</strong></h1>
        </asp:Panel>
