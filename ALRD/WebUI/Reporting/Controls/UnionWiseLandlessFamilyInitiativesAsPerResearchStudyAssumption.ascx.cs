...
{
    public partial class UnionWiseLandlessFamilyInitiativesAsPerResearchStudyAssumption : BaseControl
    {
        ...
        protected void btnShow_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                entity.FromYear = ddlYear.SelectedIndex > 0 ? long.Parse(ddlYear.SelectedValue) : -99;
                entity.ToYear = ddlYear.SelectedIndex > 0 ? long.Parse(ddlYear.SelectedValue) : -99;
                ...
                entity.ReportType = "LandlessFamilyInitiativesAsPerResearchStudyAssumption";
        ...
        {
            string ReportSource = "../RDLC/RPT_UnionWiseLandlessFamilyInitiativesAsPerResearchStudyAssumption.rdlc";
