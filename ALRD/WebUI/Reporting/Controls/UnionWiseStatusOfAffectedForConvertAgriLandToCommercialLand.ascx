<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseStatusOfAffectedForConvertAgriLandToCommercialLand.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseStatusOfAffectedForConvertAgriLandToCommercialLand" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Convert Agri. Land To Commercial Land</strong></h1>
        </asp:Panel>
