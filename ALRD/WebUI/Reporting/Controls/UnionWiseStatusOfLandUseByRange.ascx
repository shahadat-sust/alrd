<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseStatusOfLandUseByRange.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseStatusOfLandUseByRange" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Status Of Land Use By Range</strong></h1>
        </asp:Panel>
