<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DistrictWiseDistributedKashLand.ascx.cs" Inherits="WebUI.Reporting.Controls.DistrictWiseDistributedKashLand" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>District Wise Distributed Kash Land</strong></h1>
        </asp:Panel>
