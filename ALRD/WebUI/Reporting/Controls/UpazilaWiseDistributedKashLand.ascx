<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpazilaWiseDistributedKashLand.ascx.cs" Inherits="WebUI.Reporting.Controls.UpazilaWiseDistributedKashLand" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Upazila Wise Distributed Kash Land</strong></h1>
        </asp:Panel>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="w97 pd-10 form-container">
                <table class="w100 iTable">
                    ...
                    <tr>
                        <td class="w15">
                            <asp:Label ID="Label6" runat="server" Text="Division" CssClass="bold"/>
                        </td>
                        <td class="w30">
                        ...
                        <td class="w15">
                            <asp:Label ID="Label8" runat="server" Text="District" CssClass="bold"/>
                        </td>
                        <td class="w30">
                            <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="w250px required" />
                             <asp:Label ID="Label9" runat="server" CssClass="asteric" Text="*" />
                        </td>
                    </tr>
                </table>
                <br />
