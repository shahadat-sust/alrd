<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseLandlessFamilyInitiativesAsPerResearchStudyAssumptionByRange.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseLandlessFamilyInitiativesAsPerResearchStudyAssumptionByRange" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Landless Family & Initiatives By Range</strong></h1>
        </asp:Panel>
