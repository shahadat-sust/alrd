<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseFisherFolkFamilyCoparativesInitiatives.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseFisherFolkFamilyCoparativesInitiatives" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Fisher Folk Family, Coparatives & Initiatives</strong></h1>
        </asp:Panel>
