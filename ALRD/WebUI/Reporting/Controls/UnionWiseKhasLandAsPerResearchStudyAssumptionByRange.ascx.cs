...
{
    public partial class UnionWiseKhasLandAsPerResearchStudyAssumptionByRange : BaseControl
    {
        ...
        {
            string ReportSource = "../RDLC/RPT_UnionWiseKhasLandAsPerResearchStudyAssumptionByRange.rdlc";
