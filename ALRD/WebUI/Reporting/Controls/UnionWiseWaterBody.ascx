<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseWaterBody.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseWaterBody" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Water Body</strong></h1>
        </asp:Panel>
