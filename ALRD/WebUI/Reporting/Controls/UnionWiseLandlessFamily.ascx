<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseLandlessFamily.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseLandlessFamily" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Landless Family</strong></h1>
        </asp:Panel>
