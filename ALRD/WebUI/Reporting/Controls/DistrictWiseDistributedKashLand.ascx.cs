...
{
    public partial class DistrictWiseDistributedKashLand : BaseControl
    {
        ...
        {
            string ReportSource = "../RDLC/RPT_DistrictWiseDistributedKashLand.rdlc";
