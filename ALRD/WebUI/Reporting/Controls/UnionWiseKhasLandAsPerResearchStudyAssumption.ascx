<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UnionWiseKhasLandAsPerResearchStudyAssumption.ascx.cs" Inherits="WebUI.Reporting.Controls.UnionWiseKhasLandAsPerResearchStudyAssumption" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Khas Land (As Per Research/Study/Assumption)</strong></h1>
        </asp:Panel>
