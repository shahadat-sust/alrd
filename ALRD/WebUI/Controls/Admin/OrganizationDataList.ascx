<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OrganizationDataList.ascx.cs" Inherits="WebUI.Controls.Admin.OrganizationDataList" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Organization Collected Info</strong></h1>
        </asp:Panel>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            <asp:Panel ID="pnlSearchHotel" runat="server" ClientIDMode="Static" CssClass="hotel-search">
                ...
                <div class="w100">
                    <table class="w100 iTable">
                        <tr>
                            <td class="w40">
                                <asp:Label ID="lblHotelName" runat="server" Text="Org. Name" />
                            </td>
                            <td class="w60">
                                <asp:DropDownList ID="ddlOrgName" runat="server" CssClass="w100" />
                            </td>
                        </tr>
                        <tr>
                            <td class="w40">
                        ...
                        <tr>
                            <td class="w40">
                                <asp:Label ID="Label5" runat="server" Text="Division" />
                            </td>
                            <td class="w60">
                        ...
                        <tr>
                            <td class="w40">
                                <asp:Label ID="Label6" runat="server" Text="District" />
                            </td>
                            <td class="w60">
                        ...
                        <tr>
                            <td class="w40">
                                <asp:Label ID="Label8" runat="server" Text="Upazilla" />
                            </td>
                            <td class="w60">
                        ...
                        <tr>
                            <td class="w40">
                                <asp:Label ID="Label11" runat="server" Text="Union" />
                            </td>
                            <td class="w60">
                                <asp:DropDownList ID="ddlUnion" runat="server" CssClass="w100" />
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="hotel-list">
                ...
                <br />
                <div class="w100">
                    <asp:HyperLink ID="lnkAddNew" runat="server" Text="Add New" CssClass="abutton fr " NavigateUrl="~/Pages/Admin/OrganizationData.aspx" />                
                </div>
                 <br />
                 <br />
                 <br />
				            ...
				            <table style="width:100%" id="table" class="vTable" >
                                <thead>
                                    <tr>	
                                        ...
                                        <th class="w20">
                                            <asp:Label ID="Label3" runat="server" Text="Organization Name" />
                                        </th>						
                                        <th class="w15">
                                        ...
                                        <th class="w15">
                                            <asp:Label ID="Label9" runat="server" Text="Division" />
                                        </th>
                                        <th class="w15">
                                            <asp:Label ID="Label8" runat="server" Text="District" />
                                        </th>
                                        <th class="w15">
                                            <asp:Label ID="Label10" runat="server" Text="Upazilla" />
                                        </th>
                                        <th class="w5">
