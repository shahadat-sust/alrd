...
{
    public partial class DistrictInfo : BaseControl
    {
        #region Initialization
        private long FormID = 6;
        public bool Enable
        {
        ...
        public List<ALRD_DistrictInfoEntity> LocalDataStore
        {
            get
            {
                List<ALRD_DistrictInfoEntity> tempList = new List<ALRD_DistrictInfoEntity>();
                if (Session["ALRD_DistrictInfoEntityList"] != null)
                {
                    tempList = Session["ALRD_DistrictInfoEntityList"] as List<ALRD_DistrictInfoEntity>;
                }
                else
                {
                    Session["ALRD_DistrictInfoEntityList"] = tempList;
                }
                return tempList;
            }
            set
            {
                Session["ALRD_DistrictInfoEntityList"] = value;
            }
        }
        ...
        {
            ALRD_DistrictInfoEntity item = new ALRD_DistrictInfoEntity();

            item.DESCRIPT = ((TextBox)insertItem.FindControl("txtDESCRIPT")).Text.Trim();
            item.DivisionID = ((DropDownList)insertItem.FindControl("ddlDivisionName")).SelectedIndex > 0 ? long.Parse(((DropDownList)insertItem.FindControl("ddlDivisionName")).SelectedItem.Value) : (long?)null;

            item.CreatedBy = GlobalClass.UserID;
            item.CreatedOn = DateTime.Now;

            long i = SH.Service.ALRD_DistrictInfoService.GetService().Add(item);
        ...
        {
            ALRD_DistrictInfoEntity item = LocalDataStore[dataItemIndex];
            ...
            long i = SH.Service.ALRD_DistrictInfoService.GetService().Update(item);
        ...
        {
            ALRD_DistrictInfoEntity item = LocalDataStore[dataItemIndex];
            long i = SH.Service.ALRD_DistrictInfoService.GetService().Delete(item);
