<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GovernmentWaterBodyDataList.ascx.cs" Inherits="WebUI.Controls.Admin.GovernmentWaterBodyDataList" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Govt. Collected Info (Water Body)</strong></h1>
        </asp:Panel>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            ...
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="hotel-list">
                ...
                <br />
                <div class="w100">
                    <asp:HyperLink ID="lnkAddNew" runat="server" Text="Add New" CssClass="abutton fr " NavigateUrl="~/Pages/Admin/GovernmentWaterBodyData.aspx" />                
                </div>
                 <br />
                 <br />
                 <br />
