...
{
    public partial class GovernmentWaterBodyDataList : BaseControl
    {
        #region Initialization
        private long FormID = 17;
        ...
        private List<ALRD_GovernmentWaterBodyDataEntity> LocalEntityList
        {
            get
            {
                return Session["ALRD_GovernmentWaterBodyDataEntityList"] as List<ALRD_GovernmentWaterBodyDataEntity>;
            }
            set
            {
                if (Session["ALRD_GovernmentWaterBodyDataEntityList"] == null)
                    Session.Add("ALRD_GovernmentWaterBodyDataEntityList", value);
                else
                    Session["ALRD_GovernmentWaterBodyDataEntityList"] = value;
            }
        }
        ...
        protected void lsvUserList_ItemCommand(object sender, ListViewCommandEventArgs e)
        {
            ...
            try
            {
                ...
                if (CommandArgument.ToString() != "")
                {
                    ...
                    {
                        ALRD_GovernmentWaterBodyDataEntity entity = new ALRD_GovernmentWaterBodyDataEntity { COMPID = Value };
