...
{
    public partial class GovernmentWaterBodyData : BaseControl
    {
        #region Initialization
        private long FormID = 15;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    SearchEntity = new ALRD_GovernmentWaterBodyDataEntity();
        ...
        private ALRD_GovernmentWaterBodyDataEntity SearchEntity
        {
            get
            {
                return Session["ALRD_GovernmentWaterBodyDataEntity"] as ALRD_GovernmentWaterBodyDataEntity;
            }
            set
            {
                if (Session["ALRD_GovernmentWaterBodyDataEntity"] == null)
                    Session.Add("ALRD_GovernmentWaterBodyDataEntity", value);
                else
                    Session["ALRD_GovernmentWaterBodyDataEntity"] = value;
            }
        }
        ...
        private ALRD_GovernmentWaterBodyDataEntity BuiltEntity(ALRD_GovernmentWaterBodyDataEntity entity = null)
        {
            try
            {
                if (entity == null)
                    entity = new ALRD_GovernmentWaterBodyDataEntity();
                ...
                entity.NoOfWaterBody20Under = txtNoOfWaterBody20Under.Text.Trim() != string.Empty ? decimal.Parse(txtNoOfWaterBody20Under.Text.Trim()) : (decimal?)null;
                entity.NoOfWaterBody20Over = txtNoOfWaterBody20Over.Text.Trim() != string.Empty ? decimal.Parse(txtNoOfWaterBody20Over.Text.Trim()) : (decimal?)null;
                entity.AreaOfWaterbody20Under = txtAreaOfWaterbody20Under.Text.Trim() != string.Empty ? decimal.Parse(txtAreaOfWaterbody20Under.Text.Trim()) : (decimal?)null;
                entity.AreaOfWaterbody20Over = txtAreaOfWaterbody20Over.Text.Trim() != string.Empty ? decimal.Parse(txtAreaOfWaterbody20Over.Text.Trim()) : (decimal?)null;
            ...
            try
            {
                if (btnSave.Text == "Save")
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        LoadEntity(new ALRD_GovernmentWaterBodyDataEntity { COMPID = i});
                    }
                }
                else
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        LoadEntity(new ALRD_GovernmentWaterBodyDataEntity { COMPID = entity.COMPID });
                    }
                }
        ...
        protected void btnClear_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (hdnCOMPID.Value.Trim() != string.Empty && long.Parse(hdnCOMPID.Value.Trim()) > 0)
                    LoadEntity(new ALRD_GovernmentWaterBodyDataEntity { COMPID = long.Parse(hdnCOMPID.Value.Trim()) });
                else
                {
