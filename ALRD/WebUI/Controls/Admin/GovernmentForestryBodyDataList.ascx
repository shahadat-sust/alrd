<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GovernmentForestryBodyDataList.ascx.cs" Inherits="WebUI.Controls.Admin.GovernmentForestryBodyDataList" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            <h1><strong>Govt. Collected Info (Forestry Body)</strong></h1>
        </asp:Panel>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            ...
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="hotel-list">
                ...
                <br />
                <div class="w100">
                    <asp:HyperLink ID="lnkAddNew" runat="server" Text="Add New" CssClass="abutton fr " NavigateUrl="~/Pages/Admin/GovernmentForestryBodyData.aspx" />                
                </div>
                 <br />
                 <br />
                 <br />
