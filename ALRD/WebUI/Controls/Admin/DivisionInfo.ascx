<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DivisionInfo.ascx.cs" Inherits="WebUI.Controls.Admin.DivisionInfo" %>
    ...
    <contenttemplate>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="w97 pd-10">
                <div class="title-contain"> Division Setup </div>
                <div class="w100">
                    <asp:Button ID="btnAdd" runat="server" CssClass="button fr" Text="Add New Division" onclick="btnAdd_Click"/> 
                </div>
                        ...
                        <table id="tbl_RoomInfo" class="vTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="w80">
                                        <asp:Label ID="Label6" runat="server" Text="Division Name" /></th>                      
                                    <th class="w10">
                        ...
                        <tr>
                            <td colspan="6">
                                    <table class="iTable form-container">
                                        <tr>
                                            <td class="w30">
                                               <asp:Label ID="Label2" runat="server" Text=" Division Name " />
                                            </td>                                                 
                                            <td class="w70">
