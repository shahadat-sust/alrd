<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GovernmentWaterBodyData.ascx.cs" Inherits="WebUI.Controls.Admin.GovernmentWaterBodyData" %>
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <contenttemplate>
        ...
        <asp:Panel id="pTitle" ClientIDMode="Static" runat="server" CssClass="page-title">
            ...
            <a class="backto-prev fr" runat="server" href="~/Pages/Admin/GovernmentWaterBodyDataList.aspx">Back to Previous</a>
        </asp:Panel>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="w97 pd-10 form-container">
                <div class="title-contain" style="text-align:center"> 
                    <span style="font-size:22px;text-align:center">Information Collected from Government (Water Body)</span> 
                    <br />
                ...
                <table class="w100 iTable">
                    <tr>
                        <td>
                            <asp:Label ID="Label27" runat="server" Text="1. District / Upazila wise Water body (As per Government Information):" CssClass="bold" Font-Size="12"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <table class="w100 iTable">
                                    <tr>
                                        <td colspan="2"></td>
                                        <td>
                                            <asp:Label ID="Label28" runat="server" Text="Under 20 acre" CssClass="bold"/>   
                                        </td>
                                        <td>
                                            <asp:Label ID="Label29" runat="server" Text="Over 20 acre" CssClass="bold"/>   
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="w5">
                                            <asp:Label ID="Label30" runat="server" Text="1.1" CssClass="bold"/>                                          
                                        </td> 
                                        <td class="w30">
                                            <asp:Label ID="Label31" runat="server" Text="No of waterbody" CssClass="bold"/> 
                                        </td>
                                        <td class="w25">
                                            <asp:TextBox ID="txtNoOfWaterBody20Under" runat="server" CssClass="w200px decimalnr" style="text-align:right;"/>
                                        </td>
                                        <td class="w25">
                                            <asp:TextBox ID="txtNoOfWaterBody20Over" runat="server" CssClass="w200px decimalnr" style="text-align:right;"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:Label ID="Label35" runat="server" Text="1.2" CssClass="bold"/>                                          
                                        </td> 
                                        <td>
                                            <asp:Label ID="Label36" runat="server" Text="Area of Waterbody (In Acre)" CssClass="bold"/> 
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtAreaOfWaterbody20Under" runat="server" CssClass="w200px decimalnr" style="text-align:right;"/>
                                        </td>
                                        <td>
                                            <asp:TextBox ID="txtAreaOfWaterbody20Over" runat="server" CssClass="w200px decimalnr" style="text-align:right;"/>
                                        </td>
                                    </tr>
