<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UpazilaInfo.ascx.cs" Inherits="WebUI.Controls.Admin.UpazilaInfo" %>
    ...
    <contenttemplate>
		...
		<asp:Panel ID="bContent" runat="server" ClientIDMode="Static" CssClass="content">
            <asp:Panel ID="pnlForm" runat="server" ClientIDMode="Static" CssClass="w97 pd-10">
                <div class="title-contain"> Upazilla Setup </div>
                <div class="w100">
                    <asp:Button ID="btnAdd" runat="server" CssClass="button fr" Text="Add New Upazilla" onclick="btnAdd_Click"/> 
                </div>
                        ...
                        <table id="tbl_RoomInfo" class="vTable">
                            <thead>
                                <tr>
                                    ...
                                    <th class="w30">
                                        <asp:Label ID="Label6" runat="server" Text="Upazilla Name" /></th>
                                    <th class="w30">
                                        <asp:Label ID="Label7" runat="server" Text=" District Name" /></th> 
                                    <th class="w30">
                                        <asp:Label ID="Label4" runat="server" Text=" Division Name" /></th>                      
                                    <th class="w5">
                        ...
                        <tr>
                            <td colspan="6">
                                    <table class="iTable form-container">
                                        <tr>
                                            <td class="w30">
                                               <asp:Label ID="Label2" runat="server" Text=" Upazilla Name " />
                                            </td>                                                 
                                            <td class="w70">
                                        ...
                                        <tr>
                                            <td class="w30">
                                               <asp:Label ID="Label8" runat="server" Text=" District Name " />
                                            </td>                                                 
                                            <td class="w70">
                                                <asp:DropDownList ID="ddlDistrictName" runat="server"  CssClass="w257px required" />
                            ...
                            <td colspan="6">
                                    <table class="iTable form-container">
                                        ...
                                        <tr>
                                            ...
                                            <td class="w70">
                                                <asp:DropDownList ID="ddlDistrictName" runat="server" CssClass="w250px required"/>
